...
% Atlas Arm
AS = atlas_const(5);
q_Arm = [pi/6; pi/6; pi/6; pi/6; pi/6; pi/6; pi/6]; % zeros(1,7)';
q_wbody = zeros(30,1);
...
tau_ext = J_test' * rotate_wrench(F_i_test, T_W_i(1:3,1:3) );

J_Arm = J(:,AS.JI_lArm);

F_W_i = pinv(J_Arm')*tau_ext(AS.JI_lArm); % Gl. (58). In Welt-KS!!!
